...
export class ParentCompComponent implements OnInit {
  ...
  createParentCompanyDetailTabForm() {
    this.parentCompanyDetailForm = this.fb.group({
      ...
      OwnerPhone: ['', [Validators.minLength(14), Validators.maxLength(14)]],
      ...
      ManagerPhone: ['', [Validators.minLength(14), Validators.maxLength(14)]],
      ...
      ITPhone: ['', [Validators.minLength(14), Validators.maxLength(14)]],
      ...
      BillingPhone: ['', [Validators.minLength(14), Validators.maxLength(14)]],
