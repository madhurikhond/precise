...
import { FrontDeskPortalComponent } from './front-desk-portal.component';
...
const routes: Routes = [
  {
  path: '', component: FrontDeskPortalComponent, children: [ 
    {
...
export class FrontDeskPortalRoutingModule { }
