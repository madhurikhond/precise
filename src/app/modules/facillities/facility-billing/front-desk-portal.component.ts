...
@Component({
  ...
  templateUrl: './front-desk-portal.component.html',
  styleUrls: ['./front-desk-portal.component.css']
})
export class FrontDeskPortalComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    private readonly notificationService: NotificationService, private readonly commonMethodService :CommonMethodService) { }
...
//Method To Get Drop Down list 
  ...
  GetFacilityDepartment() {
    ...
    //     });
    //  }
    this.router.navigate([`facilities/facility-billing/front-desk-portal`]);
  }
