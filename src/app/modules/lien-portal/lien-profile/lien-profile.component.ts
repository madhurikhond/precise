...
@Component({
  selector: 'app-lien-profile',
  templateUrl: './lien-profile.component.html',
  styleUrls: ['./lien-profile.component.css']
})
export class LienProfileComponent implements OnInit {
  user: userDetail;
  maxDate = new Date();
  model: any = {};
