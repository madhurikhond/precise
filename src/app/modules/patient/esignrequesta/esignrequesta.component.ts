...
@Component({
  selector: 'app-esignrequesta',
  templateUrl: './esignrequesta.component.html',
  styleUrls: ['./esignrequesta.component.css']
})

export class EsignrequestaComponent implements OnInit {
  ...
  changelanguage(event) {
    if (event.target.checked === false) {
      this.router.navigate(['patient/esignrequestas'], {
        ...
        if (this.selectedModOfSignature === 'Draw') {
          if (this.f.valid) {
            let data = {
              ...
              attorneyDriverName: this.model.driverFirstName ? this.model.driverFirstName : this.allSignData.DriverName
            };
            this.patientService
          ...
          let data = {
            ...
            patientsignature: this.allSignData.PatientSignature,
            attorneySignatureName: this.typeSignature,
            attorneyDriverName: this.model.driverFirstName ? this.model.driverFirstName : this.allSignData.DriverName
          };
