...
const routes: Routes = [
  ...
  { path: 'ordered-reviewer', component: OrderedreviewerComponent, canActivate: [AuthGuard] },
  { path: 'ordered-scheduler', component: OrderedSchedulerComponent, canActivate: [AuthGuard, RoleGuard] },
  { path: 'comm-failure', loadChildren: () => import('./comm-failure/comm-failure.module').then(m => m.CommFailureModule), canActivate: [AuthGuard] },
  { path: 'call-patient-confirmation', component: CallPatientScheduleComponent, canActivate: [AuthGuard, RoleGuard] },
  { path: 'qc-completed-studies', loadChildren: () => import('./qc-completed-studies/qc-completed-studies.module').then(m => m.QcCompletedStudiesModule), canActivate: [AuthGuard] },
