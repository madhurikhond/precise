...
export class CaseUpdateAndCollectionComponent implements OnInit {
 ...
 onPageSizeChange(event) {
  this.pageSize = event;
  this.pageNumber = 1;
  this.workflowService.CaseUpdateAndCollection(true,this.getupdatesAndCollections(), this.pageNumber, this.pageSize)
...
this.workflowService.CaseUpdateAndCollection(true, data, this.pageNumber, this.pageSize).subscribe((res) => {
      if (res) {
        var data: any = res;
