...
@Component({
  selector: 'app-pregnancy-waivers',
  templateUrl: './pregnancy-waivers.component.html',
  styleUrls: ['./pregnancy-waivers.component.scss']
})
export class PregnancyWaiversComponent implements OnInit {
