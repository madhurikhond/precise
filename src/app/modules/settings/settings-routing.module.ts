...
const routes: Routes = [
  ...
  { path: 'server-settings/use-bookmark', component: UseBookmarkComponent, canActivate: [AuthGuard] },
  { path: 'server-settings/player-type', component: PlayerTypeComponent, canActivate: [AuthGuard] },
  { path: 'server-settings/sftp', component: SftpComponent, canActivate: [AuthGuard,RoleGuard] },
  { path: 'billing-settings/pi-billing', loadChildren: () => import('../settings/billing/pi-billing/pi-billing.module').then(m => m.PiBillingModule), canActivate: [AuthGuard] },
  { path: 'billing-settings/billing-detail', loadChildren: () => import('../settings/billing/billing-detail/billing-detail.module').then(m => m.BillingDetailModule), canActivate: [AuthGuard] },
  { path: 'server-settings/automations', loadChildren: () => import('../settings/server-settings/automations/automations.module').then(m => m.AutomationsModule), canActivate: [AuthGuard] },
  { path: 'RIS-settings/alerts',loadChildren: () => import('./RIS-settings/alerts/alerts.module').then(m => m.AlertsModule), canActivate: [AuthGuard] },
  { path: 'RIS-settings/completed-study', component: CompleteStudyComponent, canActivate: [AuthGuard] },
  { path: 'logs/communication',loadChildren: () => import('./logs/communication/communication.module').then(m => m.CommunicationModule), canActivate: [AuthGuard] },
  ...
  { path: 'reminders', loadChildren: () => import('../settings/reminders/reminders.module').then(m => m.RemindersModule), canActivate: [AuthGuard] },
];
